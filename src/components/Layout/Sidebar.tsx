...
const navItems: NavItem[] = [
  ...
  { key: 'invoices', label: 'Invoices', roles: ['admin', 'manager', 'accountant'] },
  { key: 'collections', label: 'Collections', roles: ['admin', 'manager', 'accountant'] },
  { key: 'driver-settlements', label: 'Driver Settlements', roles: ['admin', 'manager', 'accountant'] },
  { key: 'owner-settlements', label: 'Owner Settlements', roles: ['admin', 'manager', 'accountant'] },
