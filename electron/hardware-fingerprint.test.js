...
describe('Hardware Fingerprint', () => {
    ...
    it('should generate a consistent fingerprint', async () => {
        const fp1 = await (0, hardware_fingerprint_1.getHardwareFingerprint)();
        const fp2 = await (0, hardware_fingerprint_1.getHardwareFingerprint)();
        expect(fp1).toBe(fp2);
    });
    it('should generate a unique hash', async () => {
        const fp = await (0, hardware_fingerprint_1.getHardwareFingerprint)();
