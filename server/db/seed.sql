...
VALUES
  ...
  ('90000000-0000-0000-0000-000000000007', 'GT-TRP-2001', '20000000-0000-0000-0000-000000000006', '35000000-0000-0000-0000-000000000006', '40000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000001', '2026-03-08', 'outstation', 'Deepak Bhoi', 'MCL Mobility Desk', '60000000-0000-0000-0000-000000000001', '70000000-0000-0000-0000-000000000006', '71000000-0000-0000-0000-000000000050', NULL, '2026-03-08T06:00:00+05:30', '2026-03-10T11:00:00+05:30', 70000, 70370, 370, 10, 0, 'MCL HQ', 'Talcher Mine', 'Parent trip billed through standalone annexures', 5, 'completed', 8880, 0, 0, 0, 0, 8880, 0, 0, 0, 0, 0, 0, 8880, false, NULL, NULL, 0, 0, 0, 0, 'Parent trip for single and grouped annexure invoice demo.', (SELECT id FROM profiles WHERE email = 'admin@travelerp.com')),
...
VALUES
  ('92000000-0000-0000-0000-000000000001', 'ANN-01', '90000000-0000-0000-0000-000000000007', '2026-03-08', '2026-03-08', 70000, 70120, 120, 3, 0, 2880, true, '93000000-0000-0000-0000-000000000003'),
  ('92000000-0000-0000-0000-000000000002', 'ANN-02', '90000000-0000-0000-0000-000000000007', '2026-03-09', '2026-03-09', 70120, 70260, 140, 4, 0, 3360, true, '93000000-0000-0000-0000-000000000004'),
  ('92000000-0000-0000-0000-000000000003', 'ANN-03', '90000000-0000-0000-0000-000000000007', '2026-03-10', '2026-03-10', 70260, 70370, 110, 3, 0, 2640, true, '93000000-0000-0000-0000-000000000004')
ON CONFLICT (id) DO UPDATE
SET
  annexure_number = EXCLUDED.annexure_number,
  trip_id = EXCLUDED.trip_id,
...
VALUES
  ('92500000-0000-0000-0000-000000000001', '92000000-0000-0000-0000-000000000001', '91000000-0000-0000-0000-000000000011', 1),
  ('92500000-0000-0000-0000-000000000002', '92000000-0000-0000-0000-000000000002', '91000000-0000-0000-0000-000000000012', 1),
  ('92500000-0000-0000-0000-000000000003', '92000000-0000-0000-0000-000000000003', '91000000-0000-0000-0000-000000000013', 1)
ON CONFLICT (id) DO UPDATE
SET
...
VALUES
  ...
  ('94000000-0000-0000-0000-000000000003', '93000000-0000-0000-0000-000000000003', '90000000-0000-0000-0000-000000000007', '92000000-0000-0000-0000-000000000001', 'Annexure ANN-01 - 08 Mar 2026', '9964', 1, 2880, 2880, 2.5, 2.5, 0, 72, 72, 0, 3024),
  ('94000000-0000-0000-0000-000000000004', '93000000-0000-0000-0000-000000000004', '90000000-0000-0000-0000-000000000007', '92000000-0000-0000-0000-000000000002', 'Annexure ANN-02 - 09 Mar 2026', '9964', 1, 3360, 3360, 2.5, 2.5, 0, 84, 84, 0, 3528),
  ('94000000-0000-0000-0000-000000000005', '93000000-0000-0000-0000-000000000004', '90000000-0000-0000-0000-000000000007', '92000000-0000-0000-0000-000000000003', 'Annexure ANN-03 - 10 Mar 2026', '9964', 1, 2640, 2640, 2.5, 2.5, 0, 66, 66, 0, 2772),
